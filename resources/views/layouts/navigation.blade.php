                ...
                <div class="hidden sm:flex items-center gap-1">
                    @php
                        ...
                        if(Auth::user()->role === 'karyawan') {
                            $navItems[] = ['route' => 'tugas.index', 'label' => 'Pusat Misi'];
                        }

                        // 3. Menu KHUSUS Mentor
            ...
            <div class="hidden sm:flex items-center gap-6">
                ...
                <div class="relative leading-none">
                    ...
                    <div x-show="profileOpen" x-cloak
                         ...
                         class="absolute right-0 mt-3 w-56 bg-white dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-900 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-2xl overflow-hidden z-[70] text-left text-left">
